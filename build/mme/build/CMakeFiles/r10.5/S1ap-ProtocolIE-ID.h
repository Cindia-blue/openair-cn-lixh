...
typedef enum S1ap_ProtocolIE_ID {
	...
	S1ap_ProtocolIE_ID_id_Time_UE_StayedInCell_EnhancedGranularity	= 167,
	S1ap_ProtocolIE_ID_id_HO_Cause	= 168,
	S1ap_ProtocolIE_ID_id_VoiceSupportMatchIndicator	= 169,
